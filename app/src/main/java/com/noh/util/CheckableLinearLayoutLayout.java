...
public class CheckableLinearLayoutLayout extends LinearLayout implements Checkable {
    ...
    public CheckableLinearLayoutLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
