...
public class ShoppingDetailCoverFlow extends Gallery {
	private Camera camera = new Camera();
	public static int maxRotationAngle = 0;
	public static int maxZoom = 0;
	private int centerPoint;
	public ShoppingDetailCoverFlow(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
	public ShoppingDetailCoverFlow(Context context, AttributeSet attrs, int defStyle) {
